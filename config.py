...
class Config(object):
    ...
    REDIS_URI = os.environ.get("REDIS_URI", "redis-16253.c257.us-east-1-3.ec2.redns.redis-cloud.com") # Get This Value from http://redislabs.com/try-free (If you don't know how to obtain the a video tutorial is available here:- https://t.me/botzupdate/5)
