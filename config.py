...
class Config(object):
    ...
    REDIS_URI = os.environ.get("REDIS_URI", "16253") # Get This Value from http://redislabs.com/try-free (If you don't know how to obtain the a video tutorial is available here:- https://t.me/botzupdate/5)
