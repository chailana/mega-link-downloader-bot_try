...
class Config(object):
    ...
    APP_ID = int(os.environ.get("APP_ID", 22420997)) # Get this value from https://my.telegram.org/apps
    ...
    Bot_username = os.environ.get("Bot_username", "@Anuthing9bot") # Your bot's telegram username (must enter with '@' in the front of the username)
    ...
    REDIS_URI = os.environ.get("REDIS_URI", "redis://default@redis-16253.c257.us-east-1-3.ec2.redns.redis-cloud.com:16253") # Get This Value from http://redislabs.com/try-free (If you don't know how to obtain the a video tutorial is available here:- https://t.me/botzupdate/5)
